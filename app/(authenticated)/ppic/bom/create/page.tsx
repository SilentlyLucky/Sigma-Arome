...
/**
 * Create a new product formula for a NEW product line.
 * The product name is a free-text input — it creates a new product entry
 * alongside the formula. Existing formulas are managed from the formulas list.
 */
...
export default function CreateBOMPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Step 2: Create the formula linked to the new product.
