...
const STATUS_COLORS: Record<string, string> = { waiting_issue: 'orange', released: 'indigo', in_progress: 'violet', completed: 'teal' };
const STATUS_LABELS: Record<string, string> = { waiting_issue: 'Waiting Issue', released: 'Released', in_progress: 'In Progress', completed: 'Completed' };
