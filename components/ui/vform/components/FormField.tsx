...
import { isFieldReadOnly, isNewItem, getFieldDisplayName } from '@/lib/buildpad/utils';
...
export const FormField: React.FC<FormFieldProps> = ({
  ...
  // For auto-generated readonly fields in create mode, show a preview placeholder.
  const effectiveValue = useMemo(() => {
    if (value !== undefined && value !== null) return value;
    // In create mode, readonly fields show a preview hint
    if (context === 'create' && field.meta?.readonly) {
      return '(Auto-generated on save)';
    }
    return null;
  }, [value, context, field.meta?.readonly]);
