...
export const FormField: React.FC<FormFieldProps> = ({
  ...
  // For auto-generated readonly fields in create mode, show a hint as placeholder (grey text)
  const autoGeneratedPlaceholder = useMemo(() => {
    if (context === 'create' && field.meta?.readonly) return 'Will be auto-generated';
    return undefined;
  }, [context, field.meta?.readonly]);
