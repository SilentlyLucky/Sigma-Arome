...
export interface FormFieldInterfaceProps {
  ...
  /** Placeholder shown for auto-generated readonly fields in create mode */
...
export const FormFieldInterface: React.FC<FormFieldInterfaceProps> = ({
  ...
  const interfaceProps: any = {
    ...
    // FormField already renders the visible label and required marker. Keep
    // interface-level metadata from re-adding a label or a second asterisk.
    label: undefined,
    ...
    // Auto-generated placeholder takes priority for readonly create-mode fields
    placeholder: autoGeneratedPlaceholder || (interfaceConfig.props as any)?.placeholder || defaultPlaceholder,
  };
