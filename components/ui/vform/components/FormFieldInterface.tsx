...
import { getFieldInterface, type InterfaceConfig, type InterfaceType } from '@/lib/buildpad/utils';
import { InterfaceErrorBoundary } from './InterfaceErrorBoundary';

// Import interface components
import * as Interfaces from '@/components/ui';
...
export const FormFieldInterface: React.FC<FormFieldInterfaceProps> = ({
  ...
  const interfaceProps: any = {
    ...
    // Schema properties — never pass raw default_value to DOM (may contain SQL)
